...
**/eventupload**
- Usage: `/eventupload event_id:<biography042> event_name:<Event Name> asset_type:<notice|start|guide|trailer_mp3|voice_banner|top|raid_thumb|raid_thumb_collab> max_index:<optional>`
...
- Output: summary reports how many banners were processed/uploaded/duplicated along with wiki links for each canonical + redirect pair:
  ...
  - `trailer_mp3`, `voice_banner`, `top`, `raid_thumb`, and `raid_thumb_collab` skip the copy box and just list links.
