...
- `/imgupload page_type:<type> page_name:<title>` — bulk-upload all images for a wiki page (types: character, weapon, summon, class, class_skin, skin, npc, artifact, item, manatura, shield, skill_icons, bullet, advyrnture_gear).
