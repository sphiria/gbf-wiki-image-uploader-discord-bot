...
- `/eventupload event_id:<event folder id> event_name:<display name> asset_type:<notice|start|guide|trailer_mp3|voice_banner|top|raid_thumb|raid_thumb_collab> max_index:<optional>` — upload event banner assets and create redirects:
